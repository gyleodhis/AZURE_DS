...
model_path = f"{container_var}gold/product_demand/codo_raw_model/"
...
codo_raw_df = codo_raw_df.withColumnRenamed('SALES_DATE','ds').withColumnRenamed('QUANTITY','y')
...
merged_forecasted_sales_df = merged_forecasted_sales_df.withColumnRenamed('ds','FORECASTED_SALES_DATE').withColumnRenamed('yhat','FORCASTED_DAILY_SALES_VOLUME').withColumnRenamed('y','ACTUAL_VALUE').withColumn("FORECASTED_SALES_DATE",date_format("FORECASTED_SALES_DATE","yyyy-MM-dd"))
